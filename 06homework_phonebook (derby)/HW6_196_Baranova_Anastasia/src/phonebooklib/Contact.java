...
public class Contact {
    ...
    /**
     * Returns main info about the contact.
     *
     * @return String containing contact's name, surname and patronymic (if present).
     */
    @Override
    public String toString() {
        return name + " " + surname + (patronymic == null ? "" : " " + patronymic);
    }
    ...
    public class Builder {
        ...
        /**
         * Sets an id for a building contact.
         */
        ...
        public Builder setSurname(String surname) {
            if (surname != null && !surname.isBlank() && isValidName(surname)) {
        ...
        public Builder setPatronymic(String patronymic) {
            if (isValidName(patronymic)) {
                Contact.this.patronymic = patronymic == null ? "" : patronymic;
            }
            return this;
        }
        ...
        public Builder setHomePhone(String homePhone) {
            if (isValidNumber(homePhone)) {
                Contact.this.homePhone = homePhone == null ? "" : homePhone;
            }
            return this;
        }
        ...
        public Builder setMobilePhone(String mobilePhone) {
            if (isValidNumber(mobilePhone)) {
                Contact.this.mobilePhone = mobilePhone == null ? "" : mobilePhone;
            }
            return this;
        }
        ...
        public Builder setAddress(String address) {
            if (isValidValue(address)) {
                Contact.this.address = address == null ? "" : address;
            }
            return this;
        }
        ...
        public Builder setNotes(String notes) {
            if (isValidValue(notes)) {
                Contact.this.notes = notes == null ? "" : notes;
            }
            return this;
        }
        ...
        /**
         * Checks if passed string can represent a valid name (consists of letters, spaces, apostrophes and dashes only).
         *
         * @return true, if string can be a name, false otherwise.
         */
        ...
        /**
         * Checks if passed string does not contains semicolons.
         *
         * @return true, if string does not contains semicolons, false otherwise.
         */
